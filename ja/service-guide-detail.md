...
> 예를 들면 ‘공지사항’, ‘기술 공유’ 와 같은 게시판을 대체할 수 있습니다. 만일 공개 프로젝트가 아니라 비공개 프로젝트로 설정했다면 새로운 동료 가입할 때마다 ‘공지사항’, ‘기술 공유’ 프로젝트에 해당 사용자를 추가해야 하는 일을 하게 됩니다.
...
공개 프로젝트이지만 프로젝트 멤버가 아닐 경우, 자신이 쓴 이슈만 보이는 프로젝트입니다. 즉 프로젝트의 멤버가 아니어도 업무를 등록할 수 있으려면 공개 프로젝트를 만들며 됩니다. 하지만 프로젝트 비 멤버가 다른 사람이 등록한 업무를 보지 못하게 제한하고 싶다면 공개 프로젝트로는 부족합니다. 
> 예를 들어, 특허 검토, 법무 검토와 같은 일입니다. 이런 상황에서 쓰기만 공개 프로젝트를 만드시면 편리합니다.
...
프로젝트 이름 옆에 있는 [+] 아이콘을 클릭합니다. 커다른 쓰기창이 아니라 아주 간략한 쓰기 창을 볼 수 있습니다.
